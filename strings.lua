...
return {
	de = {
		["nighty_x_offset"] = ("X-Verschiebung"),
		...
		["better_signals_y_offset_tooltip"] = ("Wähle auf welcher Seite vom Gleis, das Signal snappen soll."),
		...
		["nighty_type_n_korb"] = ("Signal Korb"),
	...
	en = {
		...
		["better_signals_x_offset_tooltip"] = ("Wähle den Versatz, mit welchem das Signal an das Gleis snappen soll"),
		["better_signals_y_offset"] = ("Signal Y-Offset"),
		["better_signals_y_offset_tooltip"] = ("Choose on which side the signals should snap"),
		...
		["nighty_type_n_korb"] = ("Signaling Bridge Type"),
